quotes = [
...

	{
		author: "JR Smith",
		body:
			"There's nothing. There's no going out, there's no late nights. There's video games, basketball and basketball."
	},
	{
		author: "Nick Saban",
		body:
			"There are feelings and there are choices. Fatigue, tiredness, those are feelings, a choice is to give in or overcome."
	},
	{
		author: "Edwin Louis Cole",
		body: "You don't drown by falling in the water; you drown by staying there."
	},
	{
		author: "Lao Tzu",
		body:
	...
	{
		author: "Chieko Okazaki",
		body: "In principle, great clarity. In practice, great charity."
	},
	{
	...
	},
	{
		author: "Henry Ford",
		body:
			"Failure is simple the opportunity to begin again, this time more inteliigently."
	},
	{
		author: "William Shakespeare",
		body: "Nothing in this world is good or bad, but thinking makes it so."
	},
	{
		author: "Sun Tzu",
		body:
	...
	{
		author: "Rick Rubin",
		body: "Never talk down to the audience."
	},
	{
		author: "Martin Luther King Jr.",
		body: "If I cannot do great things, I can do small things in a great way."
	},
	{
		author: "C. JoyBell C.",
		body:
			"Do not yearn to be popular; be equisite. Do not desire to be famous; be loved. Do not take pride in being expected; be palpable, unmistakable."
	},
	{
	...
	},
	{
		...
		body:
			"Don't wait for extraordinary opportunities. Seek common occasions and make them great. Weak men wait for opportunities. Strong men make them."
	},
	{
	...
	},
	{
		...
		body:
			"Giving consistent effort in the little things in day-to-day life leads to greatness."
	},
	{
		author: "Henry Ford",
		body:
	...
	},
	{
		...
		body:
			"You can make a throne of bayonets, but you can't sit on it for very long."
	},
	{
		author: "Colin Powell",
		body:
	...
	},
	{
		author: "Oren Harari",
		body:
			"The electric light did not come from come from the continuous improvement of candles."
	},
	{
	...
	},
	{
		author: "Howard W. Hunter",
		body:
			"Example carries with it an influence much more forceful than precept."
	},
	{
	...
	},
	{
		author: "Liz Wiseman",
		body:
			"The best leaders don't have the answers. They have really good questions, and they use their intelligence to bring out the genius in the people around them."
	},
	{
	...
	},
	{
		...
		body:
			"Few people have ever changed for the better as a result of constant criticism or nagging. If we are not careful, some of what we offer as constructive criticism is actually destructive. At times, it is better to leave some things unsaid."
	},
	{
